...
namespace {
    ...
    namespace elastic_scaled_integer_neg_inf_rounding {

        // Positive
        static_assert(identical(
                cnl::convert<
                        cnl::neg_inf_rounding_tag, cnl::elastic_scaled_integer<16, cnl::power<0>>>{}(cnl::elastic_scaled_integer<16, cnl::power<-4>>{
                        5.25}),
        ...
        static_assert(identical(
                cnl::convert<cnl::neg_inf_rounding_tag, cnl::elastic_scaled_integer<16, cnl::power<0>>>{}(cnl::elastic_scaled_integer<16, cnl::power<-4>>{
                        5.5}),
                cnl::elastic_scaled_integer<16, cnl::power<0>>{5.0}));
        ...
        static_assert(identical(
                cnl::convert<cnl::neg_inf_rounding_tag, cnl::elastic_scaled_integer<16, cnl::power<-1>>>{}(cnl::elastic_scaled_integer<16, cnl::power<-4>>{
                        5.25}),
        ...
        // Negative
        static_assert(identical(
                cnl::convert<cnl::neg_inf_rounding_tag, cnl::elastic_scaled_integer<16, cnl::power<0>>>{}(
        ...
        static_assert(identical(
                cnl::convert<cnl::neg_inf_rounding_tag, cnl::elastic_scaled_integer<16, cnl::power<-1>>>{}(
                        cnl::elastic_scaled_integer<16, cnl::power<-4>>{-5.25}),
    ...
    template<
            int Digits, int Exponent = 0, cnl::rounding_tag RoundingTag = cnl::neg_inf_rounding_tag,
            class Narrowest = signed>
    using elastic_scaled_integer_neg_inf =
            cnl::scaled_integer<rounding_elastic_integer<Digits, RoundingTag, Narrowest>, cnl::power<Exponent>>;

    namespace elastic_scaled_integer_neg_inf_implicit_conversions {
        ...
        static_assert(
                ...
                "conversion 1 (elastic_scaled_integer_neg_inf)");
        static_assert(
                identical(q4_1{-0.5}, static_cast<q4_1>(q4_4{-0.25})),
                "conversion 2 (elastic_scaled_integer_neg_inf)");
        static_assert(
                identical(q4_1{-1.0}, static_cast<q4_1>(q4_4{-0.75})),
                "conversion 3 (elastic_scaled_integer_neg_inf)");
        static_assert(
                identical(q4_1{0.5}, static_cast<q4_1>(q4_4{0.75})),
                "conversion 4 (elastic_scaled_integer_neg_inf)");
    }

    namespace elastic_scaled_integer_neg_inf_multiply {
        using q4_20 = elastic_scaled_integer_neg_inf<24, -20>;
        using q4_4 = elastic_scaled_integer_neg_inf<8, -4>;
        using q4_1 = elastic_scaled_integer_neg_inf<5, -1>;
    ...
    namespace elastic_scaled_integer_neg_inf_divide {
        using q4_4 = elastic_scaled_integer_neg_inf<8, -4>;
        using q4_1 = elastic_scaled_integer_neg_inf<5, -1>;
