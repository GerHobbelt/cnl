...
{
    test_function(basic_arithmetic_example, "6.28318530321121215\n360\n");
}
...
TEST(index, boost_example)  // NOLINT
{
    test_function(
            boost_example,
            "1.e100\n9.99999999999999999997707746235853377088268628876724831177561317388"
            "688460742223401456454683384940352996717699238685486921e-101\n");
}
#endif
